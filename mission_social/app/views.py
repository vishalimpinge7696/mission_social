...
from .forms import ExtendedUserCreationForm, UserProfileForm, ExtendedUserCreationForm2, UserProfileForm2
...
def register2(request):
    if request.method == 'POST':
        ...
        form = ExtendedUserCreationForm2(request.POST)
        profile_form = UserProfileForm2(request.POST)
        ...
        form = ExtendedUserCreationForm2()
